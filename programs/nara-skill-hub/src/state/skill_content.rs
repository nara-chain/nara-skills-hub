...
/// Fixed header (72 bytes) followed immediately by raw content bytes.
///
...
pub struct SkillContent {
    /// Same as the SkillRecord's authority at the time of finalization.
...
impl SkillContent {
    /// Discriminator (8) + authority (32) + skill (32).
    pub const HEADER_SIZE: usize = 8 + 32 + 32;
